...
\centering
	...
	\end{subfigure}
\caption[Hadronic light-by-light diagrams contributing to the magnetic moment]{HLbL diagrams contributing to \amu. Feynman diagrams made with References~\cite{tikz-feynman,tikz-feynhand}.}	
\label{fig:HLbL}
\end{figure}
