...
\centering
    ...
    \end{subfigure}
\caption[Examples of fit start scans when effects are improperly accounted for in fitting]{Examples of fit start scans when effects are improperly accounted for in fitting. Data are from the Endgame dataset.}
