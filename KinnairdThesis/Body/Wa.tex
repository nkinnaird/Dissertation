...
In order to eliminate this effect, an approximation of the pileup is constructed and then subtracted from the time spectra before fitting. The method used in this analysis is called the shadow method, originally developed in E821 \cite{E821PileupShadow}.
