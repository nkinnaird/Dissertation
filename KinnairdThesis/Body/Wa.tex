...
Once the reconstruction has processed all the hits into clusters, the time spectra histograms needs to be made. Some of the parameter choices for the constructed histograms were informed by analysis results. 



- maybe e threshold is its own section??
...
-all parameters were identical between the analyzed datasets for comparison and combinations sake


-need a table of chosen parameters in the histogramming - maybe at the end though
-pileup sdt, sgt, adt, energy threshold, bin width
