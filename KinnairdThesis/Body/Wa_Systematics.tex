...
-R plots and chi2 plots tail off in a flatter way for small lifetimes compared to large lifetimes
-put in same pictures probably for 60h dataset
-no real minimum - probably take it out of table
-I think probably don't include 0x and 2x numbers - argue away somehow why I do it differently for the lifetime - I think I probably can 
-can reduce table and make it no longer landscape
-maybe a mention how the k loss parameters and such might compensate
-not sure what to do or say about negative slope in the 9d...
-lifetime and amplitude will be correlated by some amount
-make the conservative choice and add errors quadratically
-include error in local summary table and update any relevant text
-include error in final summary table and update any relevant text (including abstract)
