...
\graphicspath{{Body/Figures/ExperimentalOverview/Auxiliary/}{Body/Figures/ExperimentalOverview/Ring/}{Body/Figures/TrackingFigures/TrackerPics/}{Body/Figures/ExperimentalOverview/Ring/}{Body/Figures/TrackingFigures/CoordSys/}}
...
Readout electronics live in aluminum manifolds above and below the straws.


electronics readout section / paragraph in between the module description and the station description? I think so
-mention that electronics were manufactured at BU? yes
...
- description of read out electonics - cite will
...
-potentially cite saskia here too
