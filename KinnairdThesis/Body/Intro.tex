...
The sum of the \amu contributions listed here is \cite{Kinoshita1,Kinoshita2,Ishikawa:2018rlv,Keshavarzi:2018mgv,Nyffeler:2016gnb}
		\begin{equation}
		\begin{aligned}
            a_{\mu}^{\text{SM}} &= a_{\mu}^{\text{QED}} + a_{\mu}^{\text{EW}} + a_{\mu}^{\text{Had}}, \\
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{AlexKPaperComparison}
