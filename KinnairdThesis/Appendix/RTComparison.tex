...
\centering
    ...
    \end{subfigure}% %you need this % here to add spacing between subfigures
\caption[Mean \R value comparison in Toy MC between T-Method and Ratio Method]{Toy MC study investigating differences in expected $R$ values between Ratio Method and T-Method fits due to different randomizations. The statistical precision on $R$ for a single fit is approximately \SI{1.3}{ppm}.}
