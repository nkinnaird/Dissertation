...
\begin{figure}[]
	...
	\caption[Comparison between theoretical and experimental values for \amu]{Various theoretical values for \amu on the left, as compared to the most recent experimental result on the right. \cite{Keshavarzi:2018mgv}}
