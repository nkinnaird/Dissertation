...
% \begin{tabular}{@{\extracolsep{\fill}}lcccK}
  \hline
    \multicolumn{5}{c}{\textbf{Systematic Error due to }} \\
  \hline\hline
  ...
  \hline
    60h & 89.9 & 0.56 & 2.0 & \\
    HighKick & 69.4 & 0.68 & -23.0 &  \\
    9d & 63.7 & 0.26 & 0.8 & \\ 
    Endgame & 95.1 & 0.18 & 21.3 \\
  \hline
\end{tabular*}
\caption[Systematic error due to ]{units are in }
...
-talk about relative sensitivities between t method an r method and how this is a major strength of the raito method


-no real minimimum in the chi2 fit to the ratio points
-endgame had a point at the 2x amplitude which had a noticeably smaller chi2 than the other points
-the high ick trend was negative in R

-mention how the T method minimum implies the gain is off? and that the ratio method is not as susceptible to the problem?
-include T method minimum in plots?

-since there is no minimum in the R method chi2 plot the uncertainties are conservatively taken as blank - cite personal communication with anna - check elba talk to see what I quoted for the errors


-talk about how modifying the lifetime parameter for the gain error doesn't really add anything over modifying the amplitude
