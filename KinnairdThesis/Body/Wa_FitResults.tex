...
The means for the $R$ distributions of the datasets which shared the same blinding string \{HighKick, 9d, Endgame\} are close but not quite consistent when accounting for the error on the mean, calculated as
  ...
  \end{align}
where $N$ is the number of random seeds. This inconsistency is on the order of couple hundres of ppb or up to $10-20\sigma$ in the mean error. This is very likely attributable to different field conditions over the course of Run~1.
