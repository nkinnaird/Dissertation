...
\centering
	...
	\end{subfigure}
\caption[HLbL]{HLbL diagrams contributing to \amu. Feynman diagrams made with \cite{tikz-feynman,tikz-feynhand}.}	
\label{fig:HLbL}
\end{figure}
...
\centering
	...
	\end{feynhand}
	\end{tikzpicture}
\caption[BSMDiagram]{An example Feynman diagram, where the leptons couple to the magnetic field through some BSM physics. Feynman diagrams made with \cite{tikz-feynman,tikz-feynhand}.}	
\label{fig:BSM}
\end{figure}
