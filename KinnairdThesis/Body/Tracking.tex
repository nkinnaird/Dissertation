...
with the left right data and the real DCA and error mesurements , the p value distribution looks like ... 


\begin{figure}[]
    \centering
    \includegraphics[width=.5\textwidth]{LatestData_Pvalue_lessCut}
    \caption[P value distribution for fitted tracks in data]{P value distribution for fitted tracks in data. A cut has been made at 1\% to remove tracks which have failed the fitting. The distribution can be seen to rise towards zero where tracks have been fit but imperfectly.}
