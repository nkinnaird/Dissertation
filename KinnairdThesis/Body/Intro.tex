...
% put in here along with the paragraph below possible explanations with new physics - they don't need to be comprehensive, just a couple of paragraphs and summary sentences - if my committee wants improvements they can give me updates

% get new physics suggestions from Dave's latest email BSM presentation, Aaron's thesis, slide in my departmental seminar which I got from Aaron
% read abstracts, introductions, and conclusions of most papers
...
% what about the dark photon - talk about it at all? maybe say it was recently excluded
...
\cite{crivellin2019bto,Abe_2019} % 2 higgs doublet models

\cite{PhysRevD.98.113002} % other article which is a summary of others, also source for vectorlike fermions

Since the value of \amu receives contributions from all particles that couple to the muon through virtual loops, unknown particles might be the source of this discrepancy. Specifically, since the contribution to the magnetic moment from heavy virtual particles goes as 
		\begin{align}
...
Because the discrepancy from the previous experiment was not at the five standard deviation level necessary to classify it as a discovery, the E989 experiment was undertaken. Indeed with the lack of new physics results coming out of most other experiments, E989 is especially positioned to uncover something new at a time when there are so few hints of new physics. Because of this, the interest in the E821 experiment and it's successor E989 has grown over time. The number of citations for the E821 results has been consistently high for 20 years as shown in \figref{fig:E821Citations}.
