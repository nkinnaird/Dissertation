...
% Could show truth fit results after initial chi2 section, and then show material fit results after material correlations section
%     -plots to show: pvalue, chi2 for a single ndf with overlaid line, 5 truth pulls, just to show that the track fitting is working
%     -don't show distributions yet - save those for material or LR fits
