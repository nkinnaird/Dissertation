...
By taking the difference between these two frequencies we arrive at the "spin difference frequency"
        ...
        \end{align}
a frequency that is directly proportional to the anomalous magnetic moment $a$. Briefly note that if $g = 2$ as in a Dirac theory, then the particles spin would turn at the same rate as the momentum vector, and this spin difference frequency \wa would be identically 0. If this spin difference frequency for a muon and the external magnetic dipole field can be measured, then then the anomalous magnetic moment of the muon \amu can be measured. The details of the former will be explained in this chapter, while that of the latter will be explained in \chapref{chapter:MagneticFieldMeasurement}.



How can \wa for muons be measured? Positive muons decay to a positron and two neutrinos, as shown in \figref{fig:mudecay}. This is a parity violating process such that the positrons are preferentially emitted in a direction parallel to the muon spin at the time of decay in the muon rest frame. This is a consequency of the parity violating nature of the weak interaction which prefers left-handed particles and right-handed anti-particles \cite{book}. \figref{fig:MuonDecayImproved} shows pictorial views of the muon and its decay products, along with the resulting spin and momentum vectors of each particle. Decay positrons with maximum energy will be emitted opposite to the two neutrinos. Since neutrinos must be left-handed, and thus have their spins anti-parallel to their momentum, and since anti-neutrinos must be right-handed, and thus have their spins parallel to their momentum, by the law of conservation of angular momentum the positron must have its spin be parallel to the spin of the muon at the time of decay. By the opposite argument, decay positrons emitted with minimum energy such that the neutrinos are ejected opposite to one another must have its spin be anti-parallel to that of the muon at the time of decay. 
