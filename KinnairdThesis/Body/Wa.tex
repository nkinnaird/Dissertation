...
As mentioned at the end of \secref{sec:Histogramming}, the VW effect is time-randomized out of the data, such that 
    \begin{align}
        V(t) = 1. 
    \end{align}
...
\centering
    ...
    \begin{subfigure}[]{0.48\textwidth}
        ...
        % \caption{}
    \end{subfigure}
\caption[Lost muon $\Delta t$ and energy deposition distributions]{$\Delta t$ (left) and energy deposition (right) distributions for lost muons passing through adjacent calorimeters, where counts have been included from hits in both calos. Typical flight times and energy depositions are \ns{6.5} and 170~\MeV respectively. Data are from the Endgame dataset.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{deltaT12_beforeAccSubtraction_Endgame}
