...
\centering
    ...
    \begin{subfigure}[]{0.45\textwidth}
        ...
        \caption{Endgame dataset.}
    \end{subfigure}
\caption[Energy threshold scan fits]{$R$ versus energy threshold for the Run~1 precession frequency analysis datasets. The fit points lie in and around the $1\sigma$ statistical bands.}
